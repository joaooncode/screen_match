...
public class Title {
    ...
    protected ArrayList<Double> userRating;
    protected int duration;
    protected String synopsis;
    protected String director;
    protected String[] actors;
    protected boolean isIncludedPlan;

    //Construtor
    public Title(String title, String genre, int releaseYear, ArrayList<Double> userRating, int duration, String synopsis, String director, String[] actors, boolean isIncludedPlan) {
        this.title = title;
        this.genre = genre;
    ...
    // Segundo construtor da classe Title, sem o atributo 'duration'
    public Title(String title, String genre, int releaseYear, ArrayList<Double> userRating, String synopsis, String director, String[] actors, boolean isIncludedPlan) {
        this(title, genre, releaseYear, userRating, 0, synopsis, director, actors, isIncludedPlan);
    }
